...
-(void)countDownWithStratDate:(NSDate *)startDate finishDate:(NSDate *)finishDate completeBlock:(DateComplete)completeBlock{
    if (_timer==nil) {
...
-(void)countDownWithStratTimeStamp:(long long)starTimeStamp finishTimeStamp:(long long)finishTimeStamp completeBlock:(DateComplete)completeBlock{
    if (_timer==nil) {

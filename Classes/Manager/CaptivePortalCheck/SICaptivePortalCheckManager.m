...
@interface SICaptivePortalCheckManager ()<WKNavigationDelegate,UIAlertViewDelegate>
...
@implementation SICaptivePortalCheckManager

+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static SICaptivePortalCheckManager *manager = nil;
    dispatch_once(&onceToken, ^{
        if (manager == nil) {
            manager = [[SICaptivePortalCheckManager alloc] init];

...
@implementation SICallStackManager
...
+ (NSString *)callStackOfCurrentThread {
    return [self callStackOfNSThread:[NSThread currentThread]];
}

+ (NSString *)callStackOfMainThread {
    return [self callStackOfNSThread:[NSThread mainThread]];
}
